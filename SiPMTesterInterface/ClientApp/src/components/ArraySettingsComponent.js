...
function ArraySettingsComponent(props) {
    const { show, BlockIndex, ModuleIndex, ArrayIndex, handleBarcodeChange, isBarcodeFetching, inputRef } = props;
        ...
        <div className="text-center d-block d-inline-block" ref={inputContainerRef}>
            <div className="row justify-content-center">
                <div className="col mb-3">
                    <span className="me-3"><BlockLocation blockLocation={BlockIndex} /></span>
                </div>
                <div className="col mb-3">
                    <span className="me-3"><ModuleLocation moduleLocation={ModuleIndex} /></span>
                </div>
                <div className="col mb-3">
                    <span className="me-3"><ArrayLocation arrayLocation={ArrayIndex} /></span>
                </div>
            </div>
            <div className="row justify-content-center">
                <div className="col mb-3">
...
export default ArraySettingsComponent;
