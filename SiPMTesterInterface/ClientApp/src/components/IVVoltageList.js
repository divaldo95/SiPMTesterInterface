...
const IVVoltageList = ({ updateVoltageList, prevStep, nextStep, formData, updateGeneratorData }) => {
    const [startValue, setStartValue] = useState(formData.startIVValue);
    const [endValue, setEndValue] = useState(formData.endIVValue);
    const [stepValue, setStepValue] = useState(formData.stepIVValue);
            ...
            <form onSubmit={nextStep}>
                <div className="row justify-content-center mb-4">
                    <div className="col-md-8">
                        <div className="card">
                            <h5 className="card-header">IV Voltage List Generator</h5>
